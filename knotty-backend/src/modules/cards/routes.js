...
router.post('/issue/:studentId', authenticate, authorize('ADMIN', 'TEACHER'), transactionLimiter, ctrl.issue);
router.put('/:id/freeze', authenticate, authorize('ADMIN'), transactionLimiter, ctrl.freeze);
router.put('/:id/unfreeze', authenticate, authorize('ADMIN'), transactionLimiter, ctrl.unfreeze);
router.put('/:id/nfc', authenticate, authorize('ADMIN'), transactionLimiter, ctrl.linkNFC);
router.post('/:id/top-up', authenticate, authorize('ADMIN', 'BURSAR'), transactionLimiter, ctrl.topUp);
router.post('/:id/top-up-cash', authenticate, authorize('ADMIN', 'BURSAR'), transactionLimiter, ctrl.cashTopUp);
